...
INSERT INTO `dh-darkstores-live.csm_automated_tables.ytd_sps_financial_metrics`
WITH current_year_data AS (
  ...
  FROM (
    ...
    WHERE DATE(src.month) >= CAST(param_date_start AS DATE)
      AND DATE(src.month) <= CAST(param_date_end AS DATE)
