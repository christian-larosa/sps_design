...
CREATE OR REPLACE TABLE `dh-darkstores-live.csm_automated_tables.ytd_sps_market_customers`
AS
...
base AS (
  ...
  FROM `dh-darkstores-live.csm_automated_tables.ytd_sps_customer_order`
