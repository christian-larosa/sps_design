...
CREATE OR REPLACE TABLE `dh-darkstores-live.csm_automated_tables.ytd_sps_efficiency_simple`
CLUSTER BY
   global_entity_id,
   time_period
AS
...
sku_with_predominant_class AS (
  ...
  FROM `dh-darkstores-live.csm_automated_tables.ytd_sps_efficiency_month` sps
