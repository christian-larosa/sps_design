...
DECLARE param_country_code STRING DEFAULT r'pe';
...
CREATE OR REPLACE TABLE `dh-darkstores-live.csm_automated_tables.ytd_sps_financial_metrics_month`
...
date_fin AS (
  ...
  FROM `dh-darkstores-live.csm_automated_tables.ytd_sps_customer_order` AS os
  WHERE TRUE
