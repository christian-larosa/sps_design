...
CREATE OR REPLACE TABLE `dh-darkstores-live.csm_automated_tables.ytd_sps_days_payable_month`
AS
WITH
date_in AS (
...
pim AS (
  ...
  supplier_mapping AS (
    SELECT
      ...
      sm.division_type
    FROM `dh-darkstores-live.csm_automated_tables.ytd_sps_product` AS sm
