CREATE OR REPLACE TABLE `dh-darkstores-live.csm_automated_tables.sps_supplier_scoring`
AS
WITH
...
yoy_thresh AS (
  ...
  FROM `dh-darkstores-live.csm_automated_tables.sps_market_yoy`
)
...
FROM ratios r
LEFT JOIN `dh-darkstores-live.csm_automated_tables.sps_scoring_params` p
